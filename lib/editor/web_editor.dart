...
class WebEditorScreen extends StatelessWidget {
  WebEditorScreen({required this.controller, super.key})
      : imageController = ImageNotifier();
                          ...
                          child: Row(
                            children: [
                              TextButton.icon(
                                ...
                                label: const Text('Select a background image'),
                                onPressed: () async {
                                  final hasImage = await controller
                                      .imageController
                                      .selectImage();
                                  if (hasImage) {
